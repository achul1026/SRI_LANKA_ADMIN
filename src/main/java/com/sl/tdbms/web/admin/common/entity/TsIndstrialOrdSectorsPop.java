...
@NoArgsConstructor
public class TsIndstrialOrdSectorsPop extends CreateEntity{
    ...
    public TsIndstrialOrdSectorsPop(PopulationStatsDTO populationStatsDTO,String provinCd,String districtCd) {
        ...
        this.intermediateConsumption = populationStatsDTO.getIntermediateConsumption();
