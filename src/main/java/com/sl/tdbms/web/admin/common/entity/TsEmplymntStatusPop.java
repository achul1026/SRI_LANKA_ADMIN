...
@NoArgsConstructor
public class TsEmplymntStatusPop extends CreateEntity{
    ...
    public TsEmplymntStatusPop(PopulationStatsDTO populationStatsDTO, String provinCd, String districtCd) {
